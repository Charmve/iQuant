...
TOP_DIR = Path(__file__).parent.parent.joinpath("stock")

# 发件人邮箱
mail_sender = "1144262839@qq.com"
# 邮箱授权码,注意这里不是邮箱密码,如何获取邮箱授权码,请看本文最后教程
# mail_license = os.getenv("MAIL_LICENSE")
mail_license = "uptgfoagathxbabb"
# 收件人邮箱，可以为多个收件人
...
# 构造附件
attachment = MIMEText(
    open(TOP_DIR.joinpath("quantstats_report.html"), "rb").read(), "base64", "utf-8"
)
# 设置附件信息
...
def send_email(email_subject, mail_receivers, content):
